...
def update():
    ...
    right_forward_distance = rc_utils.get_lidar_average_distance(scan, 760, 20)
    left_forward_distance = rc_utils.get_lidar_average_distance(scan, 320, 20)
    ...
    setpoint = 0
    present_value = right_forward_distance - left_forward_distance
    error = present_value - setpoint
    if right_forward_distance!=0 and left_forward_distance!=0:
...
def update_slow():
    ...
    global left_forward_distance
    global right_forward_distance
    print("angle", angle, "left forward", left_forward_distance, "right forward", right_forward_distance, "error", error)
