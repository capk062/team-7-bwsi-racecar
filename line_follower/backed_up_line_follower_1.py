...
# >> Variables
speed = 1  # The current speed of the car
...
def update():
   ...
   # Search for contours in the current color iage
   update_contour()
   ...
   print("speed", speed, "angle", angle, "contour_center", contour_center, "contour_area", contour_area, "timer", timer, "error", error)
